...
# ── Palettes convectives (synchronisées avec JS calculateIPO/calculateIPG) ──
PALETTES["ipo"] = [
    (0.0,   (0,   200, 100, 0)),    # 0-9 : transparent
    (10.0,  (34,  197, 94,  255)),  # 10-24 : #22c55e vert (Faible)
    (25.0,  (234, 179, 8,   255)),  # 25-39 : #eab308 jaune (Limité)
    (40.0,  (249, 115, 22,  255)),  # 40-54 : #f97316 orange (Modéré)
    (55.0,  (234, 88,  12,  255)),  # 55-69 : #ea580c orange foncé (Marqué)
    (70.0,  (220, 38,  38,  255)),  # 70-84 : #dc2626 rouge (Fort)
    (85.0,  (147, 51,  234, 255)),  # 85-100: #9333ea violet (Très fort)
    (100.0, (147, 51,  234, 255)),
]

PALETTES["ipg"] = [
    (0.0,   (0,   200, 100, 0)),    # 0-24 : transparent (aucun signal grêle)
    (25.0,  (34,  197, 94,  255)),  # 25-39 : #22c55e vert (Grésil / petite grêle)
    (40.0,  (234, 179, 8,   255)),  # 40-54 : #eab308 jaune (Petite grêle possible)
    (55.0,  (234, 88,  12,  255)),  # 55-69 : #ea580c orange foncé (Grêle significative)
    (70.0,  (220, 38,  38,  255)),  # 70-84 : #dc2626 rouge (Grêle forte)
    (85.0,  (147, 51,  234, 255)),  # 85-100: #9333ea violet (Grêle sévère)
    (100.0, (147, 51,  234, 255)),
]

PALETTES["instabilite"] = [
    (0.0,    (0,   0,   200, 0)),
    (100.0,  (100, 150, 255, 255)),
    (300.0,  (0,   200, 255, 255)),
    (500.0,  (0,   220, 100, 255)),
    (750.0,  (180, 230, 50,  255)),
    (1000.0, (255, 230, 0,   255)),
    (1500.0, (255, 140, 0,   255)),
    (2000.0, (255, 50,  0,   255)),
    (2500.0, (220, 0,   80,  255)),
    (3500.0, (180, 0,   180, 255)),
]

PALETTES["orages_simules"] = [
    (5.0,   (0,   200, 100, 0)),
    (15.0,  (100, 200, 255, 255)),
    (25.0,  (0,   255, 200, 255)),
    (35.0,  (0,   230, 0,   255)),
    (42.0,  (255, 230, 0,   255)),
    (50.0,  (255, 140, 0,   255)),
...
# (Couche "grele_taille" supprimée : doublon exact d'IPG — échelle qualitative
#  à 7 niveaux déjà portée par la palette ipg ci-dessus.)
...
PALETTES["ipt"] = [
    ...
    (65.0,  (239, 68,  68,  255)),
    (80.0,  (168, 85,  247, 255)),
    (100.0, (168, 85,  247, 255)),
]

# Rafales convectives — seuils alignés sur l'échelle Keraunos 5 niveaux
# (60 km/h marginal, 90 modéré, 120 fort, ≥150 violent/extrême).
PALETTES["rafales_convectives"] = [
    (0.0,   (0,   200, 100, 0)),
    (60.0,  (250, 204, 21,  255)),
    (90.0,  (249, 115, 22,  255)),
    (120.0, (239, 68,  68,  255)),
    (150.0, (168, 85,  247, 255)),
]
