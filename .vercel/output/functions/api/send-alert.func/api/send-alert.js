...
const resend = new _resend.Resend('re_E1j1QCw2_CdpvkHST1mHyWkPCCEzTnf7j');
async function handler(req, res) {
  ...
  // Formatage Heure
  const dateStr = new Date(time).toLocaleDateString('fr-FR', {
    weekday: 'long',
    day: 'numeric',
    month: 'long'
  });
...
//# sourceMappingURL=send-alert.js.map